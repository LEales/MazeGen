...
public class World1TemplateTest {
    ...
    void init() {
        ...
        try {
            w1 = new World1Template(w1M, new RightPanel("11"));
    ...
    void createImageViewPos() {
        ...
        assertEquals(imageView.getImage(), w1.createImageView(image, i, i1).getImage());
    ...
    void createImageViewNeg() {
        ...
        ImageView imageView = new ImageView(image);
        assertNotEquals(imageView.getImage(), w1.createImageView(wrongImage, i, i1).getImage());
    }
    ...
    void createImageViewNull() {
        ...
        int i1 = 12;
        try {
            w1.createImageView(null, i, i1).getImage();
    ...
    void createRectanglePos() {
        ...
        double y = 2.0;
        double x = 2.0;
        Rectangle actRec = w1.createRectangle(v1, v2, y, x);
    ...
    void getWallPos() {
        ...
        Label actLabel;
        try {
            actLabel = (Label) metod.invoke(w1);
